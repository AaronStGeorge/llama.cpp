...
enum class ggml_hrx_loom_jit_source_format {
    GGML_HRX_LOOM_JIT_SOURCE_FORMAT_TEXT,
    GGML_HRX_LOOM_JIT_SOURCE_FORMAT_BYTECODE,
};
...
struct ggml_hrx_loom_jit_source {
    ...
    ggml_hrx_loom_jit_source_format source_format =
        ggml_hrx_loom_jit_source_format::GGML_HRX_LOOM_JIT_SOURCE_FORMAT_TEXT;
